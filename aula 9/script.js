...
class WebGallery extends HTMLElement {
    ...
    constructor() {
     ...
     connectedCallback() {
        ...
        this.shadowRoot.querySelector("#previous").onlick = () => {
            console.log("previous clicked");
        }
        this.shadowRoot.querySelector("#next").onlick = () => {
            console.log("next clicked");
        }
        this.shadowRoot.querySelector("#play-pause").onlick = () => {
